...
#define CYBLE_HUMON_DATA_SERVICE_SERVICE_INDEX   (0x00u) /* Index of Humon Data Service service in the cyBle_customs array */
#define CYBLE_HUMON_DATA_SERVICE_HUMON_DATA_CHARACTERISTIC_CHAR_INDEX   (0x00u) /* Index of Humon Data Characteristic characteristic */
#define CYBLE_HUMON_DATA_SERVICE_HUMON_DATA_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_INDEX   (0x00u) /* Index of Client Characteristic Configuration descriptor */


#define CYBLE_HUMON_DATA_SERVICE_SERVICE_HANDLE   (0x000Eu) /* Handle of Humon Data Service service */
#define CYBLE_HUMON_DATA_SERVICE_HUMON_DATA_CHARACTERISTIC_DECL_HANDLE   (0x000Fu) /* Handle of Humon Data Characteristic characteristic declaration */
#define CYBLE_HUMON_DATA_SERVICE_HUMON_DATA_CHARACTERISTIC_CHAR_HANDLE   (0x0010u) /* Handle of Humon Data Characteristic characteristic */
#define CYBLE_HUMON_DATA_SERVICE_HUMON_DATA_CHARACTERISTIC_CLIENT_CHARACTERISTIC_CONFIGURATION_DESC_HANDLE   (0x0011u) /* Handle of Client Characteristic Configuration descriptor */
