...
static void I2CM_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2CM_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            I2CM_RX_SDA_MOSI_HSIOM_SEL_GPIO,
            I2CM_TX_SCL_MISO_HSIOM_SEL_GPIO,
            0u,
            0u,
            0u,
            0u,
            ...
            (I2CM_SCB_MODE_EZI2C == mode))
        {
            ...
            hsiomSel[I2CM_RX_SDA_MOSI_PIN_INDEX] = I2CM_RX_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [I2CM_RX_SDA_MOSI_PIN_INDEX] = I2CM_PIN_DM_OD_LO;
        #elif (I2CM_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[I2CM_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CM_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [I2CM_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CM_PIN_DM_OD_LO;
        #else
        #endif /* (I2CM_RX_SDA_MOSI_PIN) */
        
        #if (I2CM_TX_SCL_MISO_PIN)
            hsiomSel[I2CM_TX_SCL_MISO_PIN_INDEX] = I2CM_TX_SCL_MISO_HSIOM_SEL_I2C;
        ...
        {
        #if (I2CM_RX_SDA_MOSI_PIN)
            hsiomSel[I2CM_RX_SDA_MOSI_PIN_INDEX] = I2CM_RX_SDA_MOSI_HSIOM_SEL_SPI;
        #elif (I2CM_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[I2CM_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CM_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI;
        #else
        #endif /* (I2CM_RX_SDA_MOSI_PIN) */
        
        #if (I2CM_TX_SCL_MISO_PIN)
            hsiomSel[I2CM_TX_SCL_MISO_PIN_INDEX] = I2CM_TX_SCL_MISO_HSIOM_SEL_SPI;
        #endif /* (I2CM_TX_SCL_MISO_PIN) */
        ...
        else /* UART */
        {
            if (I2CM_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (I2CM_TX_SCL_MISO_PIN)
                hsiomSel[I2CM_TX_SCL_MISO_PIN_INDEX] = I2CM_TX_SCL_MISO_HSIOM_SEL_UART;
                pinsDm  [I2CM_TX_SCL_MISO_PIN_INDEX] = I2CM_PIN_DM_OD_LO;
            #endif /* (I2CM_TX_SCL_MISO_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (I2CM_RX_SDA_MOSI_PIN)
                    hsiomSel[I2CM_RX_SDA_MOSI_PIN_INDEX] = I2CM_RX_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [I2CM_RX_SDA_MOSI_PIN_INDEX] = I2CM_PIN_DM_DIG_HIZ;
                #elif (I2CM_RX_WAKE_SDA_MOSI_PIN)
                    hsiomSel[I2CM_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CM_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [I2CM_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CM_PIN_DM_DIG_HIZ;
                #else
                #endif /* (I2CM_RX_SDA_MOSI_PIN) */
                }
