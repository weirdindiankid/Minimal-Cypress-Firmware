...
***************************************/
    ...
    #define I2CM_RX_SDA_MOSI_HSIOM_SEL_GPIO  (I2CM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define I2CM_RX_SDA_MOSI_HSIOM_SEL_I2C   (I2CM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define I2CM_RX_SDA_MOSI_HSIOM_SEL_SPI   (I2CM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define I2CM_RX_SDA_MOSI_HSIOM_SEL_UART  (I2CM_uart_rx_i2c_sda_spi_mosi__0__HSIOM_UART)
    
#elif (I2CM_RX_WAKE_SDA_MOSI_PIN)
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_REG   (*(reg32 *) I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_PTR   ( (reg32 *) I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_MASK      (I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_POS       (I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_SEL_GPIO  (I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_GPIO)
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C   (I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_I2C)
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI   (I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SPI)
    #define I2CM_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART  (I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_UART)    
   
    #define I2CM_RX_WAKE_SDA_MOSI_INTCFG_REG (*(reg32 *) I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define I2CM_RX_WAKE_SDA_MOSI_INTCFG_PTR ( (reg32 *) I2CM_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define I2CM_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (I2CM_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define I2CM_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK ((uint32) I2CM_INTCFG_TYPE_MASK << \
                                                                           I2CM_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins I2CM_RX_SDA_MOSI_PIN or I2CM_RX_WAKE_SDA_MOSI_PIN present.*/
    ...
    #define I2CM_TX_SCL_MISO_HSIOM_SEL_GPIO  (I2CM_uart_tx_i2c_scl_spi_miso__0__HSIOM_GPIO)
    #define I2CM_TX_SCL_MISO_HSIOM_SEL_I2C   (I2CM_uart_tx_i2c_scl_spi_miso__0__HSIOM_I2C)
    #define I2CM_TX_SCL_MISO_HSIOM_SEL_SPI   (I2CM_uart_tx_i2c_scl_spi_miso__0__HSIOM_SPI)
    #define I2CM_TX_SCL_MISO_HSIOM_SEL_UART  (I2CM_uart_tx_i2c_scl_spi_miso__0__HSIOM_UART)
...
/* Clear UART wakeup source */
    ...
    #define I2CM_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) I2CM_uart_rx_wake_i2c_sda_spi_mosi_ClearInterrupt(); \
            }while(0)
