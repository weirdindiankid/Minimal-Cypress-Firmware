...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    /* Humon Data Service service */
    {
        0x000Eu, /* Handle of the Humon Data Service service */ 
        {

            /* Humon Data Characteristic characteristic */
            {
                0x0010u, /* Handle of the Humon Data Characteristic characteristic */ 
