...
module top ;
	...
	wire [0:0] tmpIO_0__POWER_HOLD_net;
	wire [0:0] tmpINTERRUPT_0__POWER_HOLD_net;
	electrical [0:0] tmpSIOVREF__POWER_HOLD_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		POWER_HOLD
		 (.oe(tmpOE__POWER_HOLD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POWER_HOLD_net[0:0]}),
		  .io({tmpIO_0__POWER_HOLD_net[0:0]}),
		  .siovref(tmpSIOVREF__POWER_HOLD_net),
		  .interrupt({tmpINTERRUPT_0__POWER_HOLD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POWER_HOLD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CHARGE_STATUS_net;
	wire [0:0] tmpIO_0__CHARGE_STATUS_net;
	wire [0:0] tmpINTERRUPT_0__CHARGE_STATUS_net;
	...
	assign tmpOE__CHARGE_STATUS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__POWER_BUTTON_IN_net;
	wire [0:0] tmpFB_0__POWER_BUTTON_IN_net;
	wire [0:0] tmpIO_0__POWER_BUTTON_IN_net;
	wire [0:0] tmpINTERRUPT_0__POWER_BUTTON_IN_net;
	electrical [0:0] tmpSIOVREF__POWER_BUTTON_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("0af8789b-5adf-43c6-a85b-2a286991dbd8"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		POWER_BUTTON_IN
		 (.oe(tmpOE__POWER_BUTTON_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POWER_BUTTON_IN_net[0:0]}),
		  .io({tmpIO_0__POWER_BUTTON_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__POWER_BUTTON_IN_net),
		  .interrupt({tmpINTERRUPT_0__POWER_BUTTON_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POWER_BUTTON_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__START_BUTTON_IN_net;
	wire [0:0] tmpFB_0__START_BUTTON_IN_net;
	wire [0:0] tmpIO_0__START_BUTTON_IN_net;
	wire [0:0] tmpINTERRUPT_0__START_BUTTON_IN_net;
	electrical [0:0] tmpSIOVREF__START_BUTTON_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("76a61798-91bc-408f-aa42-0ebe82e80d6d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		START_BUTTON_IN
		 (.oe(tmpOE__START_BUTTON_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__START_BUTTON_IN_net[0:0]}),
		  .io({tmpIO_0__START_BUTTON_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__START_BUTTON_IN_net),
		  .interrupt({tmpINTERRUPT_0__START_BUTTON_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__START_BUTTON_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
